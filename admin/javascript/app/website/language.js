...
app.controller('LanguageController',
    function($scope, $rootScope, $route, apiService, $timeout, $location, $compile, $sce) {
        ...
        var filterParams = {};
        var filterIds = {};
        var data = {list: {}, header: {}, sidebar: {}, languages: {}, paging: {}, gender: {}, status: {}, sorter: {}, country_code: 'vn'};

        $scope.init = function (data) {
            if(data == isUndefined){
                data = {list: {}, header: {}, sidebar: {}, languages: {}, paging: {}, gender: {}, status: {}, sorter: {}, country_code: 'vn'};
            }
        ...
        $scope.fetchPage = function (pageNum) {
            ...
            if (!$scope.fetched) {
                return apiService.list("/website/language", filterParams).then(function (response) {
